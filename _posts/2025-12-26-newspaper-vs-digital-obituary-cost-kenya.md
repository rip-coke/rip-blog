...
Have you ever tried to write an obituary for a newspaper? It often involves painful editing.
  ...
  - **The Digital Freedom:** On a digital platform, space is unlimited. You can upload:

    - <i class="fa-solid fa-check"></i> The full 1,000-word life history (Eulogy).

    - <i class="fa-solid fa-check"></i> A gallery of 50+ photos from their childhood to their final days.

    - <i class="fa-solid fa-check"></i> The full Funeral Program (PDF).

    - <i class="fa-solid fa-check"></i> A Family Tree.
...
### Our recommendation? Use both.
  ...
  1. **Go Small in Print:** Pay for the smallest, cheapest newspaper strip available (just the name, photo, and date).

  2. **Go Big Digital:** In that small newspaper ad, include the line: *"Read the full life story and view photos at **rip.ke/[Name]**"*
...
[Get Started with rip.ke](https://rip.ke/post/). to create a permanent, beautiful, and affordable memorial.
